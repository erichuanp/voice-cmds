"""Windows implementations of the built-in system commands.

Every function has the signature fn(config, logger). Loaded only on
Windows by voice_cmds.commands.system.
"""
